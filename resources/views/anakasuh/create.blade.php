                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                          ...
                          <div class="col-sm-7">
                            <div class="form-group">
                                <input type="text" class="form-control @error('status') is-invalid @enderror"
                                    name="status" value="{{ old('status') }}" placeholder="{{ __('Status Anak') }}" required>
                                @error('status')
                                <div class="invalid-feedback"> {{ $message }} </div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-7">
                            <div class="form-group">
                                <input type="text" class="form-control @error('alamat_tinggal') is-invalid @enderror"
                                    name="alamat_tinggal" value="{{ old('alamat_tinggal') }}" 
                                    placeholder="{{ __('Alamat tempat tinggal') }}" required>
                          ...
                          <div class="col-sm-7">
                            <div class="form-group">
                                <input type="text" class="form-control @error('foto') is-invalid @enderror"
                                    name="foto" value="{{ url('image') }}" 
                                    placeholder="{{ __('Foto Anak') }}" required>
                                @error('foto')
                                <div class="invalid-feedback"> {{ $message }} </div>
                                @enderror
                            </div>
